...
class Optimizer:
    ...
    def __init__(self, X, Y, theta, V, W):
        ...
        self.goal = Obstacle(0, 0, 0, 0, 0)
        self.obsD = 2.0
        self.alpha = 1.0 # affinity for reaching goal
        self.beta = 2.0 # repulsion from obstacle
        self.gama = 0.0 # reduce jerks
    ...
    def heading(self, v, w):
        ...
        for i in range(self.depth):
            ...
            head += self.cal_distance(self.goal.x, self.goal.y, X1, Y1)
    ...
    def dis(self, v, w):
        ...
        for i in range(self.depth):
            ...
            for j, obs in enumerate(self.obstacles):
                ...
                dis += 1/self.cal_distance(x[j], y[j], X1, Y1)
    ...
    def objective(self, x):
        v = [self.V for i in range(len(x)) if i % 2 == 0]
